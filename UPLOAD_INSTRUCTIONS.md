...
4. Upload `README.md`, `generate_profile.py`, `dark_mode.svg`, `light_mode.svg`, and the `assets` folder. The generator converts `assets/profile.jpg` into the masked ASCII portrait.
